...
// let arr = quote.slice(0, 6).split("");

// for(let i = 0; i < arr.length; i++) {
//     console.log(`The character at index ${i} is '${arr[i]}'`);
// }
...
*/
console.log(quote.indexOf("o", 10)); // 14
...
*/
let secondLastA = quote.lastIndexOf('a', lastIndexOfA-1);
console.log(secondLastA);
/*
